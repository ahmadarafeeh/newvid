...
class SupabasePostsMethods {
  ...
  // ----------------------
  // Create general notification for rating
  // ----------------------
  ...
  // ----------------------
  // Create comment — normal push, unchanged
  // ----------------------
  Future<String> postComment(String postId, String text, String uid,
    ...
    try {
      ...
      if (uid != postOwnerUid && postOwnerUid.isNotEmpty) {
        ...
        // Normal push — no A/B split here. The contextual body
        // ("followed you after your comment") only fires from the
        // notification screen when the post owner taps Follow on
