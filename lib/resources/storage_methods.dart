...
// Add this helper method to the StorageMethods class
// Place it with the other helper methods around line 400

// Helper method to extract file path from Supabase URL
  Future<void> deleteMediaByUrl(String mediaUrl) async {
    try {
      ...
      } else if (_isFirebaseUrl(mediaUrl)) {
        // Handle Firebase URLs if needed
        print('Firebase URL detected: $mediaUrl');
      }
    } catch (e) {
