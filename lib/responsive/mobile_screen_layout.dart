...
class _MobileScreenLayoutState extends State<MobileScreenLayout> {
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            right: 0,
            bottom: 0,
            child: _buildGlassBottomNavBar(user?.uid ?? '', colors),
          ),
        ],
      ),
    );
  ...
  Widget _buildGlassBottomNavBar(String currentUserId, _NavColorSet colors) {
    return SafeArea(
      top: false,
      child: Container(
        height: 80,
        ...
        child: ClipRRect(
          ...
          child: BackdropFilter(
            filter: ImageFilter.blur(
              sigmaX: 8.0, // Reduced blur for better visibility
              sigmaY: 8.0,
            ),
            child: Container(
              decoration: BoxDecoration(
                color: colors.backgroundColor
                    .withOpacity(0.03), // Almost transparent
                borderRadius: BorderRadius.circular(20),
                border: Border.all(
                  color:
                      colors.iconColor.withOpacity(0.05), // Very subtle border
                  width: 0.5,
                ),
              ),
              child: Row(
                ...
                children: [
                  _buildGlassNavItem(Icons.home, 0, colors),
                  _buildGlassNavItem(Icons.search, 1, colors),
                  _buildGlassNotificationNavItem(currentUserId, 2, colors),
                  _buildGlassNavItem(Icons.person, 3, colors),
                ],
              ),
            ),
          ),
  ...
  Widget _buildGlassNavItem(IconData icon, int index, _NavColorSet colors) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isActive
              ? colors.indicatorColor.withOpacity(0.1) // Subtle active state
              : Colors.transparent,
          borderRadius: BorderRadius.circular(15),
        ),
        child: Column(
          ...
          children: [
            Icon(
              ...
              color: isActive
                  ...
                  : colors.iconColor.withOpacity(0.9), // Clear icons
              size: 24,
            ),
            if (isActive) ...[
  ...
  Widget _buildGlassNotificationNavItem(
      ...
      children: [
        ...
        Icon(
          ...
          color: widget.isActive
              ...
              : widget.iconColor.withOpacity(0.9), // Clear icon
          size: 24,
        ),
