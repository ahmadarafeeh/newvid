  ...
  static Future<void> debugAuthState() async {
    ...
    if (currentUser != null) {
      ...
      try {
        ...
        print('🔥 Firebase Token available: ${token != null}');
        print('🔐 Firebase Claims - Role: ${claims?['role']}');
        print('🔐 Firebase Claims - All: $claims');
      } catch (e) {
        print('❌ Error getting Firebase token info: $e');
      }
    } else {
