...
void main() async {
  ...
  try {
    ...
    // ESSENTIAL: Wait for Supabase with Firebase authentication
// ESSENTIAL: Wait for Supabase with Firebase authentication
    await Supabase.initialize(
      ...
      authOptions: const FlutterAuthClientOptions(
        autoRefreshToken:
            false, // Disable Supabase auto refresh since we're using Firebase tokens
      ),
      // This is the key part - provide Firebase tokens dynamically
      accessToken: () async {
...
// ... rest of your main.dart code remains the same
