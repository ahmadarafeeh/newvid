  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
            create: (_) => UserProvider()), // CHANGED to ChangeNotifierProvider
        Provider(create: (_) => SupabaseProfileMethods()),
        Provider(create: (_) => NotificationService()),
        Provider(
            create: (_) => CountryService()), // ADD CountryService provider
      ],
      child: Consumer<ThemeProvider>(
        builder: (context, themeProvider, child) {
          return MaterialApp(
            ...
            navigatorObservers: [
              CountryCheckObserver(), // ADD observer for checking on app resume
            ],
          );
        },
      ),
...
// NavigatorObserver to check country when app comes to foreground
class CountryCheckObserver extends NavigatorObserver {
  @override
  void didPush(Route<dynamic> route, Route<dynamic>? previousRoute) {
    // Check country when user navigates (app comes to foreground)
