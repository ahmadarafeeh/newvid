              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInstructionStep(
                    colors,
                    '1',
                    'Create a TikTok Content',
                    'Post one TikTok Content or picture that promotes Ratedly in a positive way. You can:\n• Create a Content showing how you use Ratedly\n• Share a picture inviting viewers to download the app\n• Showcase your favorite features\n• Be creative and authentic!',
                  ),
                  const SizedBox(height: 16),
                  ...
                  _buildInstructionStep(
                    ...
                    '2',
                    'Share Your Content',
                    'The content can be a Content or picture from any public TikTok account. Make sure it highlights Ratedly in a positive light and is publicly accessible.',
                  ),
                  const SizedBox(height: 16),
                  ...
                  _buildInstructionStep(
                    ...
                    '3',
                    'Submit Content Link',
                    'Copy and paste the link to your TikTok post in the field below. We will automatically send it to the Ratedly team for review.',
                  ),
                  ...
                  _buildInstructionStep(
                    ...
                    'After submitting your TikTok link, our team will contact you within 24 hours to verify that you are the real owner of this account. '
                  ...
                  // Link Input Field
                  Text(
                    'Submit Your TikTok Content Link',
                    style: TextStyle(
                      color: colors.textColor,
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          '• Content/picture should clearly mention or show Ratedly\n'
                          ...
                          '• You can use a picture inviting viewers to download the app\n'
