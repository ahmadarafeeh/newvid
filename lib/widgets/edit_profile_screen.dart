...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  // Track the picked file name for better file handling
  ...
  void _showEditOptions(_EditProfileColorSet colors) {
    ...
    bool hasSupabasePhoto = _isSupabasePhoto(_currentPhotoUrl);
    bool hasCustomPhoto = _image != null;
    bool hasAnyPhoto = hasGooglePhoto || hasSupabasePhoto || hasCustomPhoto;
  ...
  void _removePhoto() {
    ...
    bool isSupabasePhoto = _isSupabasePhoto(_currentPhotoUrl);
    bool hasCustomPhoto = _image != null;
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      if (_image != null) {
        // User selected a new image - upload to Supabase
        ...
        // Delete old Supabase photo if it exists (but not Google photos)
        if (_initialPhotoUrl != null &&
            _initialPhotoUrl != 'default' &&
            _isSupabasePhoto(_initialPhotoUrl)) {
        ...
        if (_initialPhotoUrl != null && _initialPhotoUrl != 'default') {
          // Only delete from Supabase Storage if it's our Supabase photo
          if (_isSupabasePhoto(_initialPhotoUrl)) {
            await StorageMethods().deleteImage(_initialPhotoUrl!);
          }
