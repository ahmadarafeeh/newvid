...
class _CommentCardState extends State<CommentCard> {
  ...
  // Updated method for ultra-transparent background colors
  Color _getTransparentCardColor(BuildContext context) {
    final themeProvider = Provider.of<ThemeProvider>(context, listen: false);
    return themeProvider.themeMode == ThemeMode.dark
        ? Colors.black.withOpacity(0.15) // Much more transparent for dark mode
        : Colors.white.withOpacity(0.1); // Much more transparent for light mode
  }
  ...
  Widget _buildReplyItem(Map<String, dynamic> data) {
    ...
    final textColor = _getTextColor(context);
    final cardColor = widget.forcedTransparent
        ? _getTransparentCardColor(context)
