    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Comments list - REMOVED THE BLACK BACKGROUND
          Expanded(
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (ctx, index) {
                          ...
                          return Container(
                            ...
                            // REMOVED THE BLACK BACKGROUND FROM THE CONTAINER
                            child: CommentCard(
                              snap: snap,
                              ...
                              onLikeChanged:
                                  _updateCommentLike, // OPTIMISTIC UPDATE CALLBACK
                              forcedTransparent: true, // FORCE TRANSPARENT MODE
                            ),
                          );
                        },
                      ),
