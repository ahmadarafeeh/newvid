...
class _ImageViewScreenState extends State<ImageViewScreen>
  ...
  // 🎯 UPDATED: Video initialization with AUTO-PLAY by default
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          _showPlayButton = false; // 🎯 Hide play button since we auto-play
        });
  ...
  // ADDED: Video listener for state changes
  void _videoListener() {
    if (!mounted) return;
        ...
        child: GestureDetector(
          ...
          child: Stack(
            ...
            children: [
              ...
              // 🎯 Show play button when video is paused - INSTANTLY UPDATES
