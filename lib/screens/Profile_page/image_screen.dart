...
// Remove this line: import 'package:Ratedly/widgets/rating_list_screen_postcard.dart';
...
class _ImageViewScreenState extends State<ImageViewScreen>
  ...
  // Video player variables - UPDATED with VideoManager
  ...
  // 🎯 UPDATED: Video initialization with modified play button logic
  ...
  // 🎯 UPDATED: Play video with instant play button hiding
  void _playVideo() {
  ...
  // 🎯 UPDATED: Pause video with instant play button showing
  void _pauseVideo() {
    if (_videoController != null && _isVideoInitialized && mounted) {
