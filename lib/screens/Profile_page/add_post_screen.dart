...
class _PermissionSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String description = needsMic
        ? 'To record videos, Ratedly needs access to your camera and microphone. Allow access to capture moments and share them with the community.'
        : 'To take photos, Ratedly needs access to your camera. Allow access to capture moments and share them with the community.';
