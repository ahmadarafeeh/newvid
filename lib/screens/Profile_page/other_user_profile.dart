    ...
    try {
      final controller = VideoPlayerController.networkUrl(
        ...
        videoPlayerOptions: VideoPlayerOptions(
          mixWithOthers:
              false, // CHANGED: Set to false for proper audio management
        ),
      );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          elevation: 0,
          title: Row(
            // 🆕 UPDATED: Wrap in Row for proper centering
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        _buildOtherMetric(followers, "Followers",
                            colors), // 🚫 CHANGED: Made unclickable
