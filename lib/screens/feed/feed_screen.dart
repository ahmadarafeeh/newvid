...
class _FeedScreenState extends State<FeedScreen> {
  ...
  // 🚀 NEW: Store fresh posts separately without showing them immediately
  ...
  Future<void> _bulkFetchUsers(List<Map<String, dynamic>> posts) async {
    ...
    try {
      // FIXED: Changed 'Select' to 'select' (lowercase)
    ...
    try {
      ...
      if (_selectedTab == 1) {
        ...
        if (cachedPosts != null && cachedPosts.isNotEmpty && mounted) {
          ...
          // 🚀 NEW: Only load fresh data in background - DON'T replace cached posts yet
          Future.microtask(() async {
            ...
            // 🚀 Store fresh data separately without replacing cached posts
        ...
        // For Following tab - load fresh data immediately
        await Future.wait([
          _loadBlockedUsers(),
          _loadFollowingIds(),
        ]);
