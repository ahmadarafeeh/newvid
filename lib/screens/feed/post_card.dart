...
class _PostCardState extends State<PostCard>
  ...
  // 🎯 REMOVED: _showPlayButton variable and complex state management
  ...
  // 🎯 UPDATED: Simplified video listener - only handles video looping
  void _videoListener() {
    if (!mounted) return;

    // Only handle video looping - remove play button state management from here
    if (_videoController != null &&
  ...
  void _playVideo() {
    if (_videoController != null &&
      ...
      // 🎯 FIXED: Simply update state to reflect playing
      if (mounted) {
        setState(() {});
      }
    }
  ...
  void _pauseVideo() {
    if (_videoController != null && _isVideoInitialized && mounted) {
      ...
      // 🎯 FIXED: Simply update state to reflect paused
      if (mounted) {
        setState(() {});
      }
    }
  ...
  // 🎯 UPDATED: Toggle video playback with simplified logic
...
// Fixed caption with proper gesture handling
  ...
  // 🎯 UPDATED: Video player with fixed play button behavior
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: [
          ...
          // 🎯 FIXED: Only show play button when video is NOT playing and initialized
